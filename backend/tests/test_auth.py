...
def test_login_access_token_inactive_user(client, session):
    ...
    login_data = {"username": inactive_user.email, "password": "testpassword"}
...
def test_reset_password_success(
    client, test_user, mock_generate_token, mock_verify_token
):
    ...
    reset_data = {"token": "mocked_token", "new_password": "newpassword123"}
